...
link-citations: yes
vignette: >
  %\VignetteIndexEntry{Basic Multiverse Analysis with mverse}
...
df_transformed %>% 
  ggplot(aes(x = transformation_branch)) + geom_histogram(bins = 3) + facet_wrap(vars(transformation_branch_branch))
```
