---
title: "Example 1-1. Combining two independent ratings."
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example 1-1. Combining two independent ratings.}
...
```{r base_r}
soccer <- soccer[!is.na(soccer$rater1), ] # remove rows with no rating
skin_option_1 <- (soccer$rater1 + soccer$rater2) / 2
